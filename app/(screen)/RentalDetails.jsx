          ...
          <View className="bg-gray-950 rounded-lg p-4 mb-4">
            ...
            <View className="space-y-2">
              ...
              <View className="flex-row justify-between">
                ...
                <Text className="text-white font-medium">
                  {rental.customerDetail?.customerName || "N/A"}
                </Text>
              </View>
              <View className="flex-row justify-between">
                <Text className="text-gray-400">Phone</Text>
                <Text className="text-white">
                  {rental.clientPhoneNumber ||
                    rental.customerDetail?.customerPhone ||
                    "N/A"}
                </Text>
              </View>
              <View className="flex-row justify-between">
                ...
                <Text className="text-white">
                  {rental.clientEmail ||
                    rental.customerDetail?.customerEmail ||
                    "N/A"}
                </Text>
              </View>
              <View className="flex-row justify-between">
                ...
                <Text className="text-white">
                  {rental.clientAadhaar ||
                    rental.customerDetail?.customerAadhar ||
                    "N/A"}
                </Text>
              </View>
            </View>
          ...
          <View className="bg-gray-950 rounded-lg p-4 mb-4">
            ...
            <View className="space-y-2">
              <View className="flex-row justify-between">
                ...
                <Text className="text-white font-medium">
                  {rental.itemDetail?.name || rental.name}
                </Text>
              </View>
              <View className="flex-row justify-between">
              ...
              <View className="flex-row justify-between">
                ...
                <Text className="text-white">
                  ₹{rental.itemDetail?.price || rental.price}
                </Text>
              </View>
            </View>
          </View>
          ...
          <View className="bg-gray-950 rounded-lg p-4 mb-4">
            ...
            <View className="flex-row justify-end">
              <Text className="text-white font-bold text-lg">
                ₹{rental.itemDetail?.price || rental.price} x{" "}
                {rental.itemDetail?.quantity || rental.quantity} Pics x{" "}
